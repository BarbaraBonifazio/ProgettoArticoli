	...
	<main role="main" class="container">
		...
		<div class='card'>
			<div class='card-header'>
				<h5>Inserisci nuovo Articolo</h5>
			...
			<div class='card-body'>
				...
				<form method="post"
					action="ExecuteInsertArticoloServlet?listaArticoliAttribute?listaCategorieAttribute" 
					...
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							<label>Categoria</label> <select id="listaCategorieAttribute"
								name="idDaInviareAExecuteInsert" class="form-control" required>
					...
					<Input type="hidden" name="listaArticoliAttribute"
						id="listaArticoliAttribute" class="form-control"
						value="${requestScope.listaArticoliAttribute}">
